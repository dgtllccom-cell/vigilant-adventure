        ...
        <table className="w-full text-left border-collapse entry-table">
          ...
          <tbody>
            ...
            {calculatedTotals.lines.length === 0 && !loading && (
              <tr>
                <td colSpan={8} className="text-center py-6 text-slate-500">No entries found. Select an account and apply filters.</td>
              </tr>
            )}
            {loading && (
              <tr>
                <td colSpan={8} className="text-center py-6 text-slate-500"><Loader2 className="h-5 w-5 animate-spin mx-auto mb-2" /> Loading data...</td>
              </tr>
            )}
          </tbody>
